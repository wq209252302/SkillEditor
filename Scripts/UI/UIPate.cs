...
public class UIPate : MonoBehaviour
{
    ...
    public void DesGather()
    {
        Destroy(m_gathers[m_gathers.Count - 1].gameObject);
        m_gathers.RemoveAt(m_gathers.Count-1);
    }
    ...
    private void Update()
    {
        camerapos.Set(this.gameObject.transform.position.x, this.gameObject.transform.position.y+1.8f, this.gameObject.transform.position.z);
